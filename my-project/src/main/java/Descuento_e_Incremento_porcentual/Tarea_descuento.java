...
public class Tarea_descuento implements JavaDelegate{

	@Override
	public void execute(DelegateExecution execution) throws Exception {
		// TODO Auto-generated method stub
		int porcentaje_aplicado = (int)execution.getVariable("porcentaje"); // En este caso quiero realizar un descuento del 10% ante la variable ingresada en el formulario por el mismo usuario
